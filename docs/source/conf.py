...
# Exclude notebooks that: (a) crash the RTD kernel due to heavy computation / OOM,
# (b) depend on local file-system writes, or (c) require optional GPU/TF dependencies.
nb_execution_excludepatterns = [
    "**/ADVANCED_FEATURES_GUIDE*",
    "**/advanced_features_analysis*",
    "**/physiological_features*",      # OOM: 19 cells of nonlinear/fractal/recurrence features
    "**/advanced_computation*",        # OOM: TF autoencoder + NN filtering
    "**/data_loader_tutorial*",        # writes/reads local CSV/JSON/npy files during build
    "**/feature_engineering_autonomic*",  # depends on local data files
]
...
html_baseurl = 'https://vital-dsp.readthedocs.io/'
...
suppress_warnings = [
    "myst_nb",
    "myst.header",           # notebook H2-start heading
    "autosummary",           # autosummary generation noise
    "ref.duplicate_label",   # duplicate object descriptions in api_reference
]