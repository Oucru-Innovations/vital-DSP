...
class WebappServiceManager:
    ...
    def __init__(self, max_memory_mb: int = 500):
        ...
        logger.info(f"WebappServiceManager initialized with {max_memory_mb}MB memory limit")
    ...
    async def stop_all_services(self) -> bool:
        ...
        try:
            ...
            service_order = ['task_processor', 'websocket_manager', 'task_queue', 'data_service']
        ...
        for service_name, service in self.services.items():
            try:
                ...
                if service_name == 'data_service':
                    ...
                    health = ServiceHealth(
                        service_name=service_name,
                        status=ServiceStatus.RUNNING if service.running else ServiceStatus.STOPPED,
                        last_check=datetime.now(),
                        response_time=response_time,
                        metadata={'stats': stats}
                    )
...
if __name__ == "__main__":
    ...
    print("\nServices:")
    print("  - Enhanced Data Service: Chunked loading, memory mapping, progressive loading")
    ...
    print("  - Integration between data loading, task processing, and real-time updates")
