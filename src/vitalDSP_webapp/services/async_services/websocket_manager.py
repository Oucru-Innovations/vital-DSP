...
class ConnectionManager:
    ...
    async def broadcast_to_topic(self, topic: str, message: WebSocketMessage) -> int:
        ...
        logger.debug(f"Broadcasted message to {sent_count} connections on topic {topic}")
        return sent_count
...
class WebSocketManager:
    ...
    def _register_default_handlers(self) -> None:
        ...
        self.message_handlers[MessageType.CONNECTION_INFO] = self._handle_connection_info
    ...
    async def handle_connection(self, websocket: WebSocket, connection_id: Optional[str] = None) -> None:
        """
        ...
        try:
            ...
            with self.connection_manager._lock:
                if connection_id in self.connection_manager.connection_metadata:
                    self.connection_manager.connection_metadata[connection_id]['last_activity'] = datetime.now()
    ...
    async def _process_message(self, connection_id: str, message: WebSocketMessage) -> None:
    ...
    async def _handle_connection_info(self, connection_id: str, message: WebSocketMessage) -> None:
    ...
    async def broadcast_task_update(self, task_id: str, update_data: Dict[str, Any]) -> int:
        """
        ...
        return await self.connection_manager.broadcast_to_topic(f"task:{task_id}", message)
    
    async def broadcast_task_progress(self, task_id: str, progress: float, message: str = "") -> int:
        """
        ...
        return await self.connection_manager.broadcast_to_topic(f"task:{task_id}", progress_message)
    ...
    async def broadcast_data_update(self, data_id: str, update_data: Dict[str, Any]) -> int:
        """
        ...
        return await self.connection_manager.broadcast_to_topic(f"data:{data_id}", message)
