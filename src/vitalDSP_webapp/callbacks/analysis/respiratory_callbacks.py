...
def _import_vitaldsp_modules():
    ...
    try:
        from vitalDSP.respiratory_analysis.features.ppg_respiratory_autonomic_features import PPGRespiratoryAutonomicFeatures
    ...
    try:
        from vitalDSP.respiratory_analysis.features.ecg_ppg_synchronization_features import ECGPpgSynchronizationFeatures
    ...
    try:
        from vitalDSP.preprocessing.preprocess_config import PreprocessConfig
    ...
    try:
        from vitalDSP.preprocessing.preprocess_signal import preprocess_signal
