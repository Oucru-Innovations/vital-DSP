...
from filtering.artifact_removal import ArtifactRemoval  # Assuming ArtifactRemoval class has been implemented
...
class ArtifactRemovalVisualization:
    ...
    def visualize_artifact_removal(self, method='mean_subtraction', **kwargs):
        ...
        self._plot_signal(cleaned_signal, title=f"Artifact Removal - {method.replace('_', ' ').title()}")
