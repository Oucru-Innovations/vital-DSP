...
def register_sidebar_callbacks(app):
    ...
    @app.callback(
        [Output("sidebar", "className"),  # Toggle sidebar class
         ...
         Output("page-content", "style")],  # Adjust content margin based on sidebar state
    ...
    def toggle_sidebar(n_clicks):
        ...
        """
        if n_clicks % 2 == 0:
            return "sidebar-expanded", "fas fa-bars", {"margin-left": "250px", "padding": "2rem 1rem"}  # Expanded
        else:
            return "sidebar-collapsed", "fas fa-arrow-right", {"margin-left": "80px", "padding": "2rem 1rem"}  # Collapsed
