...
def test_preprocess_signals(mock_preprocess, sample_signals, sample_preprocess_config):
    signal1, signal2 = sample_signals
    mock_preprocess.side_effect = lambda signal, *args, **kwargs: signal  # Return the signal as-is

    coherence_analysis = CoherenceAnalysis(signal1, signal2, fs=500)

    preprocessed_signal1, preprocessed_signal2 = coherence_analysis.preprocess_signals(
        preprocess_config1=sample_preprocess_config, preprocess_config2=sample_preprocess_config)
...
def test_align_signals(sample_signals):
    ...
    aligned_signal1, aligned_signal2 = coherence_analysis.align_signals(signal1, signal2)
...
def test_compute_coherence(mock_preprocess, sample_signals, sample_preprocess_config):
    ...
    f, Cxy = coherence_analysis.compute_coherence(preprocess_config1=sample_preprocess_config, preprocess_config2=sample_preprocess_config)
