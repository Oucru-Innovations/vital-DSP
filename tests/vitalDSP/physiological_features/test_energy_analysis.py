...
def test_compute_band_energy(energy_analysis):
    ...
    band_energy = energy_analysis.compute_band_energy(
        0.5, 1.5
    )  # Frequency band around 1 Hz
...
def test_compute_systolic_diastolic_energy(energy_analysis):
    ...
    systolic_energy, diastolic_energy = (
        energy_analysis.compute_systolic_diastolic_energy(
            systolic_peaks, diastolic_notches
        )
    )
