...
from vitalDSP.visualization.time_domain_visualization import (TrendAnalysisVisualizer, SignalSegmentationVisualizer,
                         SignalPowerAnalysisVisualizer, SignalChangeDetectionVisualizer,
                         PeakDetectionVisualizer, EnvelopeDetectionVisualizer, CrossSignalAnalysisVisualizer)
...
def test_plot_polynomial_trend(trend_visualizer, signal, mock_show):
    polynomial_trend = np.polyval([0.1, -0.5, 0.2], np.arange(len(signal)))  # Dummy data
